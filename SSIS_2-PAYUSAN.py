...
class Home(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="RosyBrown3")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "MSU-IIT STUDENT INFORMATION SYSTEM",bd=4,relief=RIDGE, font=("Bodoni MT",40,"bold"),bg="Mistyrose2", fg="Gray10")
...
#________HOME FUNCTIONS________#
        def Totalcourse():
            try:
                ...
                self.totalenrolled = Label(self, font=("Palatino roman", 60),textvariable = totalcourses, bg = "white", fg = "black")
                self.totalenrolled.place(x=860,y=180)
        ...
        def Totalstudents():
            try:
                ...
                self.totalenrolled = Label(self, font=("Palatino roman", 60),textvariable = ttlstudents, bg = "white", fg = "black")
                self.totalenrolled.place(x=330,y=180)
...
#________WINDOW BUTTONS________#
        ...
        Button1 =ssis.Button(self, text="COURSE",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="Lightpink4",command=lambda: controller.ShowFrame(Course))
        Button1.place(x=265,y=500)
        Button2 = ssis.Button(self, text="HOME",font=("Palatino roman",25,"bold"),bd=10,width = 10,bg="#cdc9c9",fg="Lightpink4",command=lambda: controller.ShowFrame(Home))
        Button2.place(x=525,y=500)
        Button3 =ssis.Button(self, text="STUDENTS",font=("Palatino roman",25,"bold"),bd=10, width = 10,bg="#cdc9c9",fg="Lightpink4",command=lambda: controller.ShowFrame(Student))
        Button3.place(x=790,y=500)

        self.totalstudents=Label(self, font=("Time new roman",27,"bold"),height=5, width = 20, bd=10,text="TOTAL NO. OF STUDENTS",anchor=CENTER, bg="white",fg="black")
        self.totalstudents.place(x=150,y=180)
        
        self.totalcourse=Label(self, font=("Time new roman", 27,"bold"),height=5, width = 20, bd=10, text="TOTAL NO. OF COURSE/S",anchor=CENTER, bg="white",fg="black")
        self.totalcourse.place(x=650,y=180)
...
class Course(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="Mistyrose3")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "C O U R S E",bd=4, font=("Times new roman",40,"bold"),bg="Mistyrose3", fg="Black")
...
#________COURSE BUTTONS________#
        ...
        self.btnRefresh = Button(self, text="Refresh", font=('Palatino roman', 14, "bold"), height=1, width=10, bg="#cdc9c9", fg="GHOSTWHITE", command=Refresh)
...
class Student(ssis.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        leftcolor = ssis.Label(self,height = 60,width=600, bg="Mistyrose2")
        leftcolor.place(x=0,y=0)
        label = ssis.Label(self, text = "STUDENT INFORMATION",bd=4, font=("Bodoni MT",30,"bold"),bg="mistyrose2", fg="black")
...
#_______LABELS AND ENTRIES_______#
        ...
        self.lblStudentID = Label(InfoFrame, font=("Palatino roman", 16,"bold"), text="ID No:", padx=5, pady=5, bg = "MISTYROSE1", fg = "BLACK", width = 10)
        ...
        self.lblStudentName = Label(InfoFrame, font=("Palatino roman", 15,"bold"), text="FULL NAME:", padx=5, pady=5, bg = "mistyrose1", fg = "BLACK",  width = 10)
        ...
        self.lblStudentCourse = Label(InfoFrame, font=("Palatino roman", 16,"bold"), text="COURSE:", padx=5, pady=5, bg = "mistyrose1", fg = "BLACK",  width = 10)
        ...
        self.lblStudentYearLevel = Label(InfoFrame, font=("Palatino roman", 15,"bold"), text="YEAR LEVEL:", padx=5, pady=5, bg = "mistyrose1", fg = "BLACK",  width = 10)
        ...
        self.lblStudentGender = Label(InfoFrame, font=("Source code", 16,"bold"), text="GENDER:", padx=5, pady=5, bg = "mistyrose1", fg = "BLACK",  width = 10)
        ...
        self.SearchBarlbl = Label(self, font=("Time new roman", 18,"bold"), text="Id Number:", padx=2, pady=2, bg = "gray35", fg = "mistyrose3")
        self.SearchBarlbl.place(x=595,y=45)        
        self.SearchBar = Entry(self, font=("Times new roman", 20), textvariable=SearchBar_Var,width=25, fg = "gray35")
